...
public enum Buffs
{
  ...
  Buff_InCombat_VBlood_Armorer_ALREADY_EXISTS_2 = 1395125392,
  ...
  BuffResistance_ArenaOrb = -1271537148,
  BuffResistance_Dispell_Standard = 663432934,
  BuffResistance_EliteMob = 1973136122,
  BuffResistance_ExplodingMosquito = 815189566,
  BuffResistance_Golem = -1736068504,
  BuffResistance_GolemRockElemental = 1413952432,
  BuffResistance_GroundedUnit = -1233147667,
  BuffResistance_Horses = -1847481569,
  BuffResistance_Hunter = 193079472,
  BuffResistance_IceBlock = -1747607804,
  BuffResistance_IgniteResistant = -992427880,
  BuffResistance_NoResistances = -149206519,
  BuffResistance_OnlyKnockbackAllowed = -1043688002,
  BuffResistance_SpellImmune = 138461582,
  BuffResistance_SpiderTanks = -1513114390,
  BuffResistance_Structures = -641281679,
  BuffResistance_UberMob = 1067748088,
  BuffResistance_UberMob_IgniteResistant = 960451195,
  BuffResistance_UberMobNoKnockback = -995401394,
  BuffResistance_UberMobNoKnockbackOrGrab = 99200653,
  BuffResistance_Vampire = -1022163918,
  BuffResistance_VBloodDownedDispell = -1114856172
};