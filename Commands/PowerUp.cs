...
namespace OpenRPG.Commands
{
    ...
    {
        [Command(name: "powerup", shortHand: "pu", adminOnly: false, usage: "pu <player_name> <add>|<remove> <max hp> <p.atk> <s.atk> <p.def> <s.def>", description: "Buff specified player with the specified value.")]
