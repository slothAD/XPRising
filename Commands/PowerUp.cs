...
namespace OpenRPG.Commands
{
    public static class PowerUp {
        ...
        public static void PowerUpCommand(ChatCommandContext ctx, string name, string flag, float MaxHP = 0, float PATK = 0, float SATK = 0, float PDEF = 0, float SDEF = 0){
            ...
            if (powerupLogging) Plugin.LogInfo("Beginning PowerUp Command");
            if (powerupLogging) Plugin.LogInfo($"Arguments are as follows: {name}, {flag}, {MaxHP}, {PATK}, {SATK}, {PDEF}, {SDEF}");
            ...
            ulong steamID;
            if (powerupLogging) Plugin.LogInfo("Trying to get steam ID");
