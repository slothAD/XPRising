...
namespace RPGMods
{
    ...
    public class Plugin : BasePlugin
    {
        ...
        public void InitConfig(){
            ...
            EXPGroupMaxDistance = Config.Bind("Experience", "XP Loss", 50f, "Set the maximum distance an ally(player) has to be from the player for them to share EXP with the player");



            pvpXPLoss = Config.Bind("Experience", "PvP XP Loss", 0f, "Sets the flat XP Lost on a PvP death");
            pvpXPLossPerLevel = Config.Bind("Experience", "PvP XP Loss per Level", 0f, "Sets the XP Lost per level of the dying player on a PvP death");
            pvpXPLossPercent = Config.Bind("Experience", "PvP XP Loss Percent", 0f, "Sets the percentage of XP to the next level lost on a PvP death");
            pvpXPLossPercentPerLevel = Config.Bind("Experience", "PvP XP Loss Percent per Level", 0f, "Sets the percentage of XP to the next level lost per level of the dying player on a PvP death");
            pvpXPLossMultPerLvlDiff = Config.Bind("Experience", "PvP XP Loss", 0f, "Adds this times the number of levels higher than your killer you are as an additional percent to your xp lost on a PvP death.");
            pvpXPLossMultPerLvlDiffSq = Config.Bind("Experience", "PvP XP Loss", 0f, "Adds this times the square of the number of levels higher than your killer you are as an additional percent to your xp lost on a PvP death.");

            
            pveXPLoss = Config.Bind("Experience", "PvE XP Loss", 0f, "Sets the flat XP Lost on a PvE death");
            pveXPLossPerLevel = Config.Bind("Experience", "PvE XP Loss per Level", 0f, "Sets the XP Lost per level of the dying player on a PvE death");
            pveXPLossPercent = Config.Bind("Experience", "PvE XP Loss Percent", 10f, "Sets the percentage of XP to the next level lost on a PvE death");
            pveXPLossPercentPerLevel = Config.Bind("Experience", "PvE XP Loss Percent per Level", 0f, "Sets the percentage of XP to the next level lost per level of the dying player on a PvE death");
            pveXPLossMultPerLvlDiff = Config.Bind("Experience", "PvE XP Loss", 0f, "Adds this times the number of levels higher than your killer you are as an additional percent to your xp lost on a PvE death.");
            pveXPLossMultPerLvlDiffSq = Config.Bind("Experience", "PvE XP Loss", 0f, "Adds this times the square of the number of levels higher than your killer you are as an additional percent to your xp lost on a PvE death.");
