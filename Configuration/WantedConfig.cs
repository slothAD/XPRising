...
public static class WantedConfig
{
    ...
    public static void Initialize()
    {
        ...
        HunterHuntedSystem.heat_cooldown = _configFile.Bind("Wanted", "Heat Cooldown", 10, "Set the reduction value for player heat per minute.").Value;
        HunterHuntedSystem.ambush_interval = _configFile.Bind("Wanted", "Ambush Interval", 60, "Set how many seconds player can be ambushed again since last ambush.").Value;
        HunterHuntedSystem.ambush_chance = _configFile.Bind("Wanted", "Ambush Chance", 50, "Set the percentage that an ambush may occur for every cooldown interval.").Value;
        ...
        HunterHuntedSystem.vBloodMultiplier = _configFile.Bind("Wanted", "VBlood Heat Multiplier", 20, "Multiply the heat generated by VBlood kills.").Value;
