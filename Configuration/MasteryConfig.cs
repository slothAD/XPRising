...
public static class MasteryConfig
{
    ...
    {
        Plugin.Log(Plugin.LogSystem.Plugin, LogLevel.Info, "Loading Weapon Mastery config");
        ...
        WeaponMasterySystem.IsDecaySystemEnabled = _configFile.Bind("Mastery", "Enable Mastery Decay", false, "Enable/disable the decay of weapon mastery when the user is offline.").Value;
        WeaponMasterySystem.MaxMastery = _configFile.Bind("Mastery", "Max Mastery Value", 100d, "Configure the maximum mastery the user can atain. (100000 is 100%)").Value;
        ...
        WeaponMasterySystem.DecayInterval = _configFile.Bind("Mastery", "Decay Interval", 60, "Every amount of seconds the user is offline by the configured value will translate as 1 decay tick.").Value;
